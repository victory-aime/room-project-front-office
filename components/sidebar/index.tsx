  ...
  return (
    ...
    >
      ...
      <div className={`mx-[56px] mt-[50px] flex items-center`}>
        <div className="ml-1 mt-1 h-2.5 font-poppins text-[16px] font-bold uppercase text-navy-700 dark:text-white">
          Room-Reserve <span className="font-medium">Pro</span>
        </div>
      </div>
